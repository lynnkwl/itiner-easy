              ...
              <div class="cardd">
                <div class="centerr">
                  ...
                  <form @submit.prevent="register">
                    ...
                    <div class="inputbox">
                      <input v-model="password" @input="checkPassword" type="password" required class="w-full p-3 rounded border" />
                      <span class="caption">
                    ...
                    <div class="inputbox">
                      <input v-model="confirm" @input="checkConfirm" type="password" required class="w-full p-3 rounded border" />
                      <span class="caption">
